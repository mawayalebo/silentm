    ...
    <section>
      ...
      <div class="grid lg:grid-cols-2 items-center lg:gap-y-6 bg-blue-500">
        <div class="max-lg:order-1 max-lg:text-center sm:p-12 p-4">
          <h2 class="text-gray-800 lg:text-5xl text-3xl font-bold lg:!leading-[56px]">Elevate Your Brand with Custom Corporate Gifts</h2>
          <p class="text-gray-800 mt-6 text-base leading-relaxed">High-quality, personalized corporate gifts tailored to your brand's identity, crafted with precision, delivered on time, and designed to leave a lasting impression on your clients.</p>
          <button type='button'
            class="bg-transparent border-2 border-gray-800 mt-12 transition-all text-gray-800 font-bold text-sm rounded-md px-6 py-2.5">Explore Our Gifts</button>
        </div>
      ...
      <div class="grid lg:grid-cols-4 md:grid-cols-2 gap-6 px-4 my-12">
        <div class="bg-gray-100 p-6 rounded-md">
          ...
          <h3 class="text-lg font-bold mb-2 text-gray-800">Boosted Morale</h3>
          <p class="text-sm text-gray-600">Personalized gifts show appreciation and make employees feel valued.</p>
        ...
        <div class="bg-gray-100 p-6 rounded-md">
          ...
          <h3 class="text-lg font-bold mb-2 text-gray-800">Increased Productivity</h3>
          <p class="text-sm text-gray-600">Happy and motivated employees are more productive.</p>
        ...
        <div class="bg-gray-100 p-6 rounded-md">
          ...
          <h3 class="text-lg font-bold mb-2 text-gray-800">Stronger Company Culture</h3>
          <p class="text-sm text-gray-600">Personalized gifts can help to build a positive and cohesive company culture.</p>
        ...
        <div class="bg-gray-100 p-6 rounded-md">
          ...
          <h3 class="text-lg font-bold mb-2 text-gray-800">Increased Employee Engagement</h3>
          <p class="text-sm text-gray-600">Personalized gifts can spark excitement and motivation, leading to increased employee engagement and participation in company activities.</p>
